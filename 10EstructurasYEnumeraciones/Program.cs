...
namespace _10EstructurasYEnumeraciones
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Pedimos el nombre de jugador 1
            ...
            // Pedimos el nombre de jugador 2
            ...
            // Invocamos a "TirarDados" y guardamos el valor radom devuelto en la variable en la variable "primerTurno"
            primerTurno = Batalla.TirarDados();

            // Determinamoss cual jugador empezará primero
            if (primerTurno == 1)
            {
                // El jugador 1 empieza primero
                Console.WriteLine($"{jugador1.Nombre} empieza primero!\n");
                
                // Enviamos primero al jugador1 para que el realice el primer ataque
            ...
            else
            {
                ...
                // Enviamos primero al jugador2 para que el realice el primer ataque
    ...
    class Jugador
    {
        ...
        // Instanciamos a "Random" para poder hacer uso de ella en "CalcularDaño"
        ...
        // Método que permite al ususario escoger uno de los 3 personaje del enum "TipoPersonaje"
        public void EscogerPersonaje()
        {
            ...
            // Mientras "opcion" no sea 1, 2 o 3, se le seguirá pidiendo al ususario que ingrese una opción
            do
            {
        ...
        // Método para que el usuasrio escoja el arma que usará
        public void EscogerArma()
        {
            ...
            do
            {
                ...
                Console.WriteLine("[3]: Martillo (Ataque: 150, Defensa: 150)");
        ...
        // Mpetodod encargado de calcular el daño que un personaje inflige sobre otro en función de los valores de ataque y defensa de su arma
    ...
    class Batalla
    {
        ...
        public static int TirarDados()
        {
            ...
            // Le asignamos a "primerTurno" uno de dos posibles valores (1 o 2) así sabremos que jugador empezará primero
        ...
        {
            // Variable encagada de controlar las rondas de los jugadores
            int ronda = 1;
            ...
            Console.WriteLine($"Presiona Enter para usar tu {jugador1Pa.ArmaEquipada}...");
            Console.ReadKey();
            jugador1Pa.Atacar();
            ...
            {
                // Mostramos la ronda que se estpa jugando
                Console.WriteLine($"RONDA {ronda}\n");
                ...
                // Le preguntamos al jugador qué desear hacer
                jugador1Pa.EscogerAtacarDefender();

                // Calculamos el daño que el jugador 1 acaba de hacerle al jugador 2
                jugador2Pa.CalcularDaño(jugador1Pa.Ataque);

                // Le preguntamos al jugador 2 que desea hacer
                jugador2Pa.EscogerAtacarDefender();
                // Calculamos el daño que el jugador acaba de hacerle al jugador 1
                jugador1Pa.CalcularDaño(jugador2Pa.Ataque);
